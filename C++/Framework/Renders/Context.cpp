...
void Context::Update()
{
	...
	D3DXMatrixInverse(&perFrame.ViewInverse, NULL, &perFrame.View);
...
Context::Context()
{
	...
	viewport = new Viewport(static_cast<UINT>(desc.Width), static_cast<UINT>(desc.Height));

	frustum = new Frustum(1000.0f, mainCamera, perspective);
}
